		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">首页</strong> / <small>按人员查询</small>
				</div>

				<div class="am-u-sm-12 am-u-md-3">
					<form action="selectbyemp" method="get">
						<div class="am-input-group am-input-group-sm">
							<select name="choiceEmp" data-am-selected="{btnSize: 'sm'}">
								<option value="ALL">所有</option>
								<c:forEach items="${RFID}" var="c">
									<option value=${c.RFIDid}>${c.empName }</a></option>
								</c:forEach>
							</select> 
