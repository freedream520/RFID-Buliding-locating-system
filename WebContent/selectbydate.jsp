		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">首页</strong> / <small>按日期查询</small>
				</div>

				<div class="am-u-sm-12 am-u-md-3">
					<form action="selectbydate" method="get">
						<div class="am-input-group am-input-group-sm">
							<select name="choiceDate" data-am-selected="{btnSize: 'sm'}">
								<option value="ALL">所有</option>
								<c:forEach items="${Date}" var="c">
									<option value=${c.date}>${c.date }</a></option>
								</c:forEach>
							</select> 
